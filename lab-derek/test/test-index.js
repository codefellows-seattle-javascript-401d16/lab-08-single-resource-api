...
describe('testing task routes', (done) => {
  before((done) => {
    server.listen(3000, () => {
  ...
  it('should return a status code 404 for unregistered routes', (done) => {
  ...
  it('should respond with "not found" for valid requests with unknown id', (done) => {
  ...
  //
  // it('should return a status code 400 if no id is provided in query string', (done) => {
  ...
  //
  // it('should POST a new object and return it, then return a status code 200 and valid data if valid id is provided in query string', (done) => {
  ...
  //
  // it('should responds with status 400 and "bad request" for  invalid body', (done) => {
  //   superagent.post('localhost:3000/api/tasks/')
  //     .send(
  //       {}
  //     ).end((err, res) => {
  ...
  //
  // it('should PUT to an object and return the updated object, then return a status code 202 and valid data if valid id is provided in query string', (done) => {
  //   superagent.post('localhost:3000/api/tasks/')
  //     .send(
  //       {
  //         "taskName": "test","xp": "50","id": "10",
  ...
  //
  // it('should return a status code 404 if valid id not found', (done) => {
